...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiError> generic(Exception ex,HttpServletRequest request){return response(HttpStatus.INTERNAL_SERVER_ERROR,"Error interno no controlado",request,Map.of());}
